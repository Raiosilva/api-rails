class CustomersController < ApplicationController
  ...
  # GET /customers/1
  def show
    render json: @customer, :except => [:created_at, :updated_at, :operation_id, :operation_ids],
    include: [
      {facilities: {except: [:created_at, :updated_at]}},
      {operations: {except: [:created_at, :updated_at]}},
      {contacts: {except: [:created_at, :updated_at]}}
  ...
  def create
    ...
    if @customer.save
      render json: @customer, status: :created, location: @customer, :except => [:created_at, :updated_at, :operation_id, :operation_ids],
      include: [
        {facilities: {except: [:created_at, :updated_at]}},
        {operations: {except: [:created_at, :updated_at]}}
      ]
